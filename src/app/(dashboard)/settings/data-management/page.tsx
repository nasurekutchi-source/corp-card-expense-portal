...
const ENTITIES: EntityConfig[] = [
  ...
  },
  {
    ...
    templateHeaders:
      "firstName,lastName,email,phone,employeeNumber,departmentCode,costCenterCode,level,designation",
    templateRows: [
      "Rahul,Verma,rahul.verma@corpcardpro.com,9876543210,EMP-001,TECH,CC-TECH-01,L5,Software Engineer",
      "Sneha,Iyer,sneha.iyer@corpcardpro.com,9876543211,EMP-002,SALES,CC-SALES-01,L4,Sales Manager",
    ],
  },
  {
    key: "hierarchy",
    label: "Hierarchy",
    description: "Visa/MC 6-level hierarchy — Bank, Program, Company, Division, Department, Cost Center",
    apiPath: "/api/v1/hierarchy/bulk",
    templateHeaders: "type,name,code,parentName,budget,glCodePrefix",
    templateRows: [
      "BANK,IDFC FIRST Bank,IDFCFB,,0,",
      "PROGRAM,Corp Card Program,CCP-01,IDFC FIRST Bank,100000000,1000",
      "COMPANY,Bharat Financial Services,BFS-IND,Corp Card Program,50000000,1100",
      "DIVISION,Technology,BFS-TECH,Bharat Financial Services,20000000,1110",
